...
public class GridViewActivity extends AppCompatActivity {
    ...
    int[] images = {R.drawable.home1, R.drawable.people, R.drawable.hospital,
            R.drawable.note4, R.drawable.ambulance2, R.drawable.profile1,
            R.drawable.search, R.drawable.message1, R.drawable.note1, R.drawable.note2 };
    String[] gridNames;
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        intent = (new Intent(getApplicationContext(), NavigationBarActivity.class));
                        startActivity(intent);
                        break;
                    case 3:
                        ...
                        break;
                    case 4:
                        intent = (new Intent(getApplicationContext(), DonorRegistration.class));
                        startActivity(intent);
                        break;
                    case 5:
                        intent = (new Intent(getApplicationContext(), FloatActionButton.class));
                        startActivity(intent);
                        break;
                    case 6:
