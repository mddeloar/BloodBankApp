...
public class ImageShowWithDetailsActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private  ImageAdapterWithDetails imageAdapter;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                    UploadWithDetails upload = dataSnapshot1.getValue(UploadWithDetails.class);
                    upload.setKey(dataSnapshot1.getKey());
                    uploadList.add(upload);

                }
                imageAdapter = new ImageAdapterWithDetails(ImageShowWithDetailsActivity.this, uploadList);
                recyclerView.setAdapter(imageAdapter);

                imageAdapter.setOnItemClickListener(new ImageAdapterWithDetails.OnItemClickListener() {
                    @Override
                    ...
                    public void onDelete(int position) {
                        UploadWithDetails selectedItem = uploadList.get(position);
